export function Summary() {
  return (
    <div className="flex flex-col gap-6 border-b border-zinc-200 pb-8 dark:border-zinc-600">
      ...
      <p>
        Tech Lead with 15+ years of experience building scalable, user-centric
        web applications. I began my career as a full-stack PHP developer, and
        while I&rsquo;ve spent much of my journey specialising in front-end
        engineering, I&rsquo;ve recently returned to full-stack work using a
        modern JavaScript/TypeScript stack to lead teams and deliver high-impact
        solutions.
      </p>
